...
L221_059
l807302o=L807_302.o sort.o
L807_302.exe: $(l807302o)
	$(CXX) -o L807_302.exe $(l807302o) 
L807_302.o: L807_302.cpp sort.cpp	
	$(CXX) -c L807_302.cpp 
...
# #L612_233.cpp
l612233o=L612_233.o graph.o
L612_233.exe: $(l612233o)
	$(CXX) -o L612_233.exe $(l612233o)

# Компиляция L612_233.o с зависимостью от заголовочного файла graph.h
L612_233.o: L612_233.cpp graph.h
	$(CXX) -c L612_233.cpp
